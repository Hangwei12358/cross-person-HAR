...
class px(nn.Module):
    def __init__(self, d_dim, x_dim, y_dim, zd_dim, zx_dim, zy_dim, args):
        ...
        self.fc1 = nn.Sequential(nn.Linear(zd_dim + zx_dim + zy_dim, 640, bias=False), nn.BatchNorm1d(640), nn.ReLU())
        ...
        self.deconv4 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=1024, out_channels=self.n_feature, kernel_size=(1, 4)),
            nn.ReLU()
        )
...
class qzd(nn.Module):
    def __init__(self, d_dim, x_dim, y_dim, zd_dim, zx_dim, zy_dim, args):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=self.n_feature, out_channels=1024, kernel_size=(1, 4)),
            nn.ReLU()
        )
        ...
        self.fc11 = nn.Sequential(nn.Linear(640, zd_dim))
...
class qzx(nn.Module):
    def __init__(self, d_dim, x_dim, y_dim, zd_dim, zx_dim, zy_dim, args):
        ...
        self.fc11 = nn.Sequential(nn.Linear(640, zx_dim))
        self.fc12 = nn.Sequential(nn.Linear(640, zx_dim), nn.Softplus())
...
class qzy(nn.Module):
    def __init__(self, d_dim, x_dim, y_dim, zd_dim, zx_dim, zy_dim, args):
        ...
        self.fc11 = nn.Sequential(nn.Linear(640, zy_dim))
